...
import cn.bugstack.springframework.tx.transaction.interceptor.DelegatingTransactionAttribute;
...
public abstract class TransactionAspectSupport implements BeanFactoryAware, InitializingBean {
    ...
    private cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttributeSource transactionAttributeSource;
    ...
    protected Object invokeWithinTransaction(Method method, Class<?> targetClass, InvocationCallback invocation) throws Throwable {
        cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttributeSource tas = getTransactionAttributeSource();
        // 查找事务注解 Transactional
        cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttribute txAttr = (tas != null ? tas.getTransactionAttribute(method, targetClass) : null);
    ...
    public cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttributeSource getTransactionAttributeSource() {
    ...
    protected TransactionInfo createTransactionIfNecessary(PlatformTransactionManager tm, cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttribute txAttr, String joinPointIdentification) {
    ...
    protected TransactionInfo prepareTransactionInfo(PlatformTransactionManager tm, cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttribute txAttr, String joinPointIdentification, TransactionStatus status) {
    ...
    protected final class TransactionInfo {
        ...
        private final cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttribute transactionAttribute;
        private final String joinPointIdentification;
        private TransactionStatus transactionStatus;
        private TransactionInfo oldTransactionInfo;

        public TransactionInfo(PlatformTransactionManager transactionManager,
                               cn.bugstack.springframework.tx.transaction.interceptor.TransactionAttribute transactionAttribute, String joinpointIdentification) {
            this.transactionManager = transactionManager;
